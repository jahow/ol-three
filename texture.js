...
var positionAttribute = new THREE.InterleavedBufferAttribute(
  buffer,
  2,
  0,
  false
);
var texCoordAttribute = new THREE.InterleavedBufferAttribute(
  buffer,
  2,
  2,
  false
...
new THREE.TextureLoader().load("patch.jpg", function(texture) {
